...
async def handle_comprar_bolitas(user_id, rtaTableroID, rtaCantBolitas):
    ...
    monto_casa = (jackpot['monto_acumulado'] + costo_total) * porcentaje_pagos["porcentaje_casa"] or 0
    monto_sponsor = (jackpot['monto_acumulado'] + costo_total) * porcentaje_pagos["porcentaje_sponsor"] or 0
    monto_ganador = (jackpot['monto_acumulado'] + costo_total) * porcentaje_pagos["porcentaje_ganador"] or 0
